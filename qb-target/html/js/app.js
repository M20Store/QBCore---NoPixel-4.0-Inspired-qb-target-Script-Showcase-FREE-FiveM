const Targeting = Vue.createApp({
    ...
    methods: {
        OpenTarget() {
            ...
            document.getElementById("hex").classList.remove("green");
            document.getElementById("hex").style.transform = "rotate(360deg)";
        },
        ...
        FoundTarget(item) {
            ...
            document.getElementById("hex").classList.add("green");
            document.getElementById("hex").style.transform = "rotate(0deg)";
        },
